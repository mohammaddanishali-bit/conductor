...
public class OpenSearchPropertiesConfiguration {
     ...
     *
     * <p>Note: removed @ConfigurationProperties to avoid duplicate definition errors in Spring Boot
     * 3.x The deprecated prefix warning in warnIfUsingDeprecatedPrefix() will still alert users.
     */
